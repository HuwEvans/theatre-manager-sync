...
function tm_sync_process_testimonial($item, $dry_run = false) {
    try {
        ...
        tm_sync_log('debug', 'Rating extraction details', [
            ...
            'RatingNumber_is_null' => isset($fields['RatingNumber']) && $fields['RatingNumber'] === null ? 'YES' : 'NO',
